  ...
  return (
    <div className="App">
      ...
      <img
        ...
        alt="e 2"
        width={90}
        className="absolute right-0 xl:-right-[2%] 2xl:-bottom-[80%] xl:-bottom-[127%] hidden xl:block z-[-1]"
      />
      <img
        src={e4}
        alt="e 2"
        width={90}
        className="absolute left-0 xl:-left-[2%] 2xl:-bottom-[160%] xl:-bottom-[220%] hidden xl:block z-[-1]"
      />
